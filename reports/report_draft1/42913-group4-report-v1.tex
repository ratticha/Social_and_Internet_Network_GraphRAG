...
\begin{table}[H]
  ...
  \label{tab:results}
  \begin{tabular}{>{\bfseries\raggedright\arraybackslash}p{4.5cm} >{\centering\arraybackslash}c >{\centering\arraybackslash}c >{\centering\arraybackslash}c >{\centering\arraybackslash}c}
    \hline
    \rowcolor{brandblue}
    \theadfont Method &
    \theadfont Mean P@10 &
...
\begin{table}[H]
  ...
  \label{tab:outputs}
  \small
  \begin{tabular}{>{\raggedright\arraybackslash}p{5.5cm} p{8.5cm}}
    \hline
    \rowcolor{brandblue}
